...
const experiences = [
  {
    ...
    outcome: <>Automated qualitative test analysis, reducing <span className="highlight">hours of manual work to seconds</span> and improving visibility into performance trends</>,
    takeaway: <>Strengthened my ability to build <span className="highlight">end-to-end product features</span>, lead development, and design <span className="highlight">AI-driven systems</span></>,
  },
  {
    id: 2,
    company: "M&T Bank",
    ...
    outcome: <>Improved <span className="highlight">deployment reliability and security</span> through automation and streamlined workflows</>,
    takeaway: <>Gained experience working with <span className="highlight">large-scale systems</span> and improving <span className="highlight">code security</span> in production environments</>,
  },
  {
    id: 3,
    ...
    outcome: <>Enabled <span className="highlight">reliable data transmission</span> between ground and flight systems across the mission lifecycle</>,
    takeaway: <>Strengthened my understanding of <span className="highlight">systems-level thinking</span> and real-time communication</>,
  },
  {
    id: 4,
    ...
    outcome: <>Delivered an event with <span className="highlight">98% attendee satisfaction</span></>,
    takeaway: <>Developed strong <span className="highlight">leadership and organizational skills</span> managing teams and large-scale events</>,
  },
];
...
function ReceiptCard({
  ...
  return (
    <article className={`receipt-shell ${pinClass} ${open ? "open" : ""}`}>
      <button
        type="button"
...
export default function Experience() {
  return (
    <section
      ...
      id="experience"
      style={{
        "--receipt-paper": `url(${receiptPaper})`,
        "--corkboard": `url(${corkboard})`,
      }}
    >
